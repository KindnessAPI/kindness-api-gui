...
void main (void) {
  ...
  // if (imgColor.a > 0.0) {
  outColor.r = 1.0 - pattern(pt.xy + imgColor.r * pt.xy + -0.7 * cos(time));
  outColor.g = 1.0 - pattern(pt.xy + imgColor.g * pt.xy + 0.0);
  outColor.b = 1.0 - pattern(pt.xy + imgColor.b * pt.xy + 0.7 * cos(time));
