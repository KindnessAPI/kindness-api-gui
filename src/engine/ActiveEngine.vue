<template>
  <div class="full">
    <ActivePipe class="full overlay" v-if="toucher" :controlType="'oribt'" :toucher="toucher" :runComposer="false" :glowConfig="glowConfig">
...
export default {
  components: {
    ...
    ActiveLearningART: () => import(/* webpackChunkName: "content" */ '../engine-visual/ActiveLearningART.vue')
  },
  data () {
    return {
      toucher: false,
